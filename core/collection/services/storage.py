...
def upload_arquivo(file_obj, content_type: str = 'image/jpeg', folder: str = 'evidencias') -> str:
    ...
    # MINIO_PUBLIC_ENDPOINT é o endereço acessível pelo browser (pode diferir do endereço
    # interno usado pelo SDK, ex: 'minio:9000' internamente vs 'localhost:9000' externamente).
