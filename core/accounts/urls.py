...
from .views import (
    ...
    GoogleCadastroComplementarView,
    ConfirmarEmailView,
    DefinirSenhaConviteView,
...
urlpatterns = [
    ...
    path('auth/completar-cadastro',      GoogleCadastroComplementarView.as_view(), name='auth-completar-cadastro'),
    path('auth/definir-senha',           DefinirSenhaConviteView.as_view(),       name='auth-definir-senha'),
